...
def main(_):
  ...
  logits, dropout_prob = models.create_model(
      ...
      is_training=True, is_transfer=True)

  # Define loss and optimizer
  ground_truth_input = tf.compat.v1.placeholder(
      tf.int64, [None], name='groundtruth_input')
  # output_prob = tf.compat.v1.identity(tf.nn.softmax(logits=logits, name='labels_softmax'))
  ...
  # saver.restore(sess, "/home/maulik/Documents/Tools/Deeplearning/tensorflow/tensorflow/examples/speech_commands/tmp/speech_commands_train/" + "conv.ckpt-18000")
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='busagent,hellobus,okagent,okbus',
